...
const UseContentApi = () => {
    ...
    slideApiObj.createHeadingSlide = (reqBody) =>  axios.post('/api/v1/slide-type/create-content-heading', reqBody);
    slideApiObj.createParagraphSlide = (reqBody) =>  axios.post('/api/v1/slide-type/create-content-paragraph', reqBody);
